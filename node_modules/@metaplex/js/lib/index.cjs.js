...
class Data {
    ...
    static serialize(args = {}) {
        return Buffer.from(borsh$1.serialize(this.SCHEMA, new this(args)));
    }
    static deserialize(data) {
        return borsh$1.deserializeUnchecked(this.SCHEMA, this, data);
    }
}
...
var borsh = /*#__PURE__*/Object.freeze({
  ...
  Data: Data,
  struct: struct,
  deserialize: borsh$1.deserialize,
  deserializeUnchecked: borsh$1.deserializeUnchecked,
  serialize: borsh$1.serialize
});
...
class PriceFloor extends Data {
    constructor(args) {
        ...
        if (this.type === exports.PriceFloorType.Minimum) {
            if (args.minPrice) {
                this.hash.set(args.minPrice.toArrayLike(buffer.Buffer, 'le', 8), 0);
            }
            else {
                this.minPrice = new BN__default["default"]((args.hash || new Uint8Array(0)).slice(0, 8), 'le');
            }
        }
    }
}
...
var _a$y, _b$6;
exports.WinnerLimitType = void 0;
...
class EditionData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetadataKey.EditionV1;
    }
}
_a$v = EditionData;
...
class EditionMarkerData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetadataKey.EditionMarker;
    }
...
class MasterEditionV1Data extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetadataKey.MasterEditionV1;
    }
}
...
class MasterEditionV2Data extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetadataKey.MasterEditionV2;
    }
}
...
class MetadataData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetadataKey.MetadataV1;
    }
}
_c$1 = MetadataData;
            ...
            const baseFilters = [
                {
                    memcmp: {
                        offset: 0,
                        bytes: bs58__default["default"].encode(buffer.Buffer.from([exports.MetadataKey.MetadataV1])),
                    },
                },
...
class AuctionManagerStateV2 extends Data {
    constructor() {
        super(...arguments);
        this.status = exports.AuctionManagerStatus.Initialized;
        this.safetyConfigItemsValidated = new BN__default["default"](0);
        this.bidsPushedToAcceptPayment = new BN__default["default"](0);
...
class AuctionManagerV2Data extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetaplexKey.AuctionManagerV2;
    }
}
...
class PayoutTicketData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetaplexKey.PayoutTicketV1;
    }
}
...
class PrizeTrackingTicketData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetaplexKey.PrizeTrackingTicketV1;
        this.key = exports.MetaplexKey.PrizeTrackingTicketV1;
    }
}
...
class WhitelistedCreatorData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetaplexKey.WhitelistedCreatorV1;
        this.activated = true;
        this.key = exports.MetaplexKey.WhitelistedCreatorV1;
    }
}
...
class StoreData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.MetaplexKey.StoreV1;
        this.public = true;
        this.key = exports.MetaplexKey.StoreV1;
    }
}
...
class AuctionWinnerTokenTypeTracker extends Account {
    ...
    static isCompatible(data) {
        return data[0] === exports.MetaplexKey.AuctionWinnerTokenTypeTrackerV1;
    }
...
const deserialize = (buffer) => {
    ...
    const lengthOfArray = new BN__default["default"](buffer.slice(3, 7), 'le');
    let offset = 7;
    for (let i = 0; i < lengthOfArray.toNumber(); i++) {
        const amount = getBNFromData(buffer, offset, data.amountType);
        offset += data.amountType;
...
class SafetyDepositBoxData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.VaultKey.SafetyDepositBoxV1;
    }
}
...
class VaultData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.VaultKey.VaultV1;
    }
}
_c = VaultData;
...
class ExternalPriceAccountData extends Data {
    constructor(args) {
        super(args);
        this.key = exports.VaultKey.ExternalPriceAccountV1;
    }
}
...
class ExternalPriceAccount extends Account {
    ...
    static isCompatible(data) {
        return data[0] === exports.VaultKey.ExternalPriceAccountV1;
    }
}
...
class InitAuctionManagerV2Args extends Data {
    constructor() {
        ...
        this.maxRanges = new BN__default["default"](1);
    }
}
...
exports.ProxyCallAddress = void 0;
...
})(exports.ProxyCallAddress || (exports.ProxyCallAddress = {}));
    ...
    constructor(options, params) {
        ...
        const data = auctioneerReclaimIndex
            ? RedeemUnusedWinningConfigItemsAsAuctioneerArgs.serialize({
                ...
                proxyCall: exports.ProxyCallAddress.RedeemBid,
            })
...
NFTPacksProgram.PUBKEY = new web3_js.PublicKey(config.programs.packs);
...
class PackCardData extends Data {
    constructor(args) {
        super(args);
        this.accountType = exports.NFTPacksAccountType.PackCard;
    }
}
_b = PackCardData;
...
class PackSetData extends Data {
    constructor(args) {
        super(args);
        this.accountType = exports.NFTPacksAccountType.PackSet;
...
class PackVoucherData extends Data {
    constructor(args) {
        super(args);
        this.accountType = exports.NFTPacksAccountType.PackVoucher;
    }
}
...
class ProvingProcessData extends Data {
    constructor(args) {
        super(args);
        this.accountType = exports.NFTPacksAccountType.ProvingProcess;
    }
}
...
exports.PackCardData = PackCardData;
exports.PackSet = PackSet;
exports.PackSetData = PackSetData;
exports.PackVoucher = PackVoucher;
exports.PackVoucherData = PackVoucherData;
...
exports.ProvingProcessData = ProvingProcessData;
...
exports.deserialize = deserialize$2;
