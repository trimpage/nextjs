...
export default class GatekeeperClient {
     ...
     */
    pollGatekeeperStatus(walletAddress: string): Promise<number>;
     ...
     */
    refreshToken(gatewayTokenKey: string, walletPublicKey: string, proof: string, payload: unknown): Promise<Response>;
}
