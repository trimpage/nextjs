var metaplex = (function (exports, web3_js, splToken) {
	...
	var deserializeUnchecked_1 = lib.deserializeUnchecked = deserialize_1 = lib.deserialize = serialize_1 = lib.serialize = BinaryReader_1 = lib.BinaryReader = BinaryWriter_1 = lib.BinaryWriter = lib.BorshError = lib.baseDecode = lib.baseEncode = void 0;
	...
	var deserialize_1 = lib.deserialize = deserialize$3;
	            ...
	            const baseFilters = [
	                {
	                    memcmp: {
	                        offset: 0,
	                        bytes: bs58.encode(buffer.Buffer.from([exports.MetadataKey.MetadataV1])),
	                    },
	                },
